...
function HomePage() {
  ...
  return (
    <>
      <Head>
        <title>{`DataHarbor Pro`}</title>

        <meta
          name="description"
          content="Welcome to DataHarbor Pro, your trusted partner in data management and storage solutions. Ensuring secure, efficient storage, organization, and access to your critical data while enhancing collaboration and productivity."
        />
      </Head>
      <ConfigureCodeBanner
      ...
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1523961131990-5ea7c61b2107?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxkYXRhJTIwbWFuYWdlbWVudHxlbnwwfHx8fDE2OTQ0NTc2OTl8MA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to DataHarbor Pro, your trusted partner in data management and storage solutions. Ensuring secure, efficient storage, organization, and access to your critical data while enhancing collaboration and productivity.`}
            </Text>
            <Box
